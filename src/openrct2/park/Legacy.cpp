...
static std::map<std::string_view, std::string_view> oldObjectIds = {
    ...
    // Convert majora's old proof of concept go karts from 2021
    { "majora.ride.rct1karts", "rct1.ride.go_karts" },
    
    // Fix errorneous IDs from early on in the rct1 vehicle project
    { "rctaa.ride.bmsd", "rct1aa.ride.twister_trains" },
    { "rct1.ride.bmsu", "rct1aa.ride.stand_up_twister_trains" },
    { "rct1.ride.rckc", "rct1.ride.rocket_cars" },
    
    // Fix old IDs from the rct1 vehicle project
    { "rct1.ride.minilady", "rct1.ride.ladybird_trains" },
    { "rct1.ride.minilog", "rct1.ride.log_trains" },
    { "rct1.ride.minirock", "rct1.ride.rocket_cars" },
    { "rct1.ride.arrsw1", "rct1.ride.suspended_swinging_cars" },
    { "rct1.ride.arrsw2", "rct1.ride.suspended_swinging_aeroplane_cars" },
    { "rct1.ride.bboat", "rct1.ride.bumper_boats" },
    { "rct1.ride.bmvd", "rct1.ride.vertical_drop_trains" },
    { "rct1.ride.bob", "rct1.ride.bobsleigh_trains" },
    { "rct1.ride.clift1", "rct1.ride.chairlift_cars" },
    { "rct1.ride.corkrc", "rct1.ride.corkscrew_trains" },
    { "rct1.ride.corkrcrv", "rct1.ride.corkscrew_trains_reversed" },
    { "rct1.ride.ctcar", "rct1.ride.cat_cars" },
    { "rct1.ride.cwood", "rct1.ride.wooden_rc_trains" },
    { "rct1.ride.cwoodrv", "rct1.ride.wooden_rc_trains_reversed" },
    { "rct1.ride.dinghy", "rct1.ride.dinghies" },
    { "rct1.ride.gioinv", "rct1.ride.inverted_trains" },
    { "rct1.ride.karts", "rct1.ride.go_karts" },
    { "rct1.ride.lfb", "rct1.ride.logs" },
    { "rct1.ride.minetrrc", "rct1.ride.mine_trains" },
    { "rct1.ride.minispin", "rct1.ride.spinning_cars" },
    { "rct1.ride.monobig", "rct1.ride.streamlined_monorail_trains" },
    { "rct1.ride.monosml", "rct1.ride.small_monorail_cars" },
    { "rct1.ride.motobike", "rct1.ride.motorbikes" },
    { "rct1.ride.msflying", "rct1.ride.swinging_lay_down_cars" },
    { "rct1.ride.mswing", "rct1.ride.single_person_swinging_cars" },
    { "rct1.ride.nrl1", "rct1.ride.steam_trains" },
    { "rct1.ride.rapboat", "rct1.ride.river_rapids_boats" },
    { "rct1.ride.rcr", "rct1.ride.racing_cars" },
    { "rct1.ride.revfall", "rct1.ride.reverse_freefall_car" },
    { "rct1.ride.spcar", "rct1.ride.sports_cars" },
    { "rct1.ride.steelrc", "rct1.ride.steel_rc_trains" },
    { "rct1.ride.steelrcrv", "rct1.ride.steel_rc_trains_reversed" },
    { "rct1.ride.togst", "rct1.ride.stand_up_trains" },
    { "rct1.ride.truck", "rct1.ride.pickup_trucks" },
    { "rct1.ride.wmmine", "rct1.ride.mine_cars" },
    { "rct1.ride.wmouse", "rct1.ride.mouse_cars" },
    { "rct1aa.ride.bmfl", "rct1aa.ride.floorless_twister_trains" },
    { "rct1aa.ride.bmrb", "rct1aa.ride.hyper_twister_trains" },
    { "rct1aa.ride.bmsd", "rct1aa.ride.twister_trains" },
    { "rct1aa.ride.bmsu", "rct1aa.ride.stand_up_twister_trains" },
    { "rct1aa.ride.clift2", "rct1aa.ride.ski_lift_cars" },
    { "rct1aa.ride.flyingrc", "rct1aa.ride.lay_down_trains" },
    { "rct1aa.ride.fsauc", "rct1aa.ride.flying_saucers" },
    { "rct1aa.ride.gtc", "rct1aa.ride.ghost_train_cars" },
    { "rct1aa.ride.helicar", "rct1aa.ride.mini_helicopters" },
    { "rct1aa.ride.monbk", "rct1aa.ride.bicycles" },
    { "rct1aa.ride.nrl2", "rct1aa.ride.steam_trains_covered" },
    { "rct1aa.ride.revcar", "rct1aa.ride.reverser_cars" },
    { "rct1aa.ride.sfric", "rct1aa.ride.side_friction_cars" },
    { "rct1aa.ride.smono", "rct1aa.ride.suspended_monorail_trains" },
    { "rct1aa.ride.smouse", "rct1aa.ride.steel_wild_mouse_cars" },
    { "rct1aa.ride.spboat", "rct1aa.ride.splash_boats" },
    { "rct1aa.ride.utcar", "rct1aa.ride.heartline_twister_cars" },
    { "rct1aa.ride.utcarrv", "rct1aa.ride.heartline_twister_cars_reversed" },
    { "rct1aa.ride.vcr", "rct1aa.ride.vintage_cars" },
    { "rct1aa.ride.vreel", "rct1aa.ride.virginia_reel_tubs" },
    { "rct1aa.ride.woodtrc", "rct1aa.ride.wooden_articulated_trains" },
    { "rct1ll.ride.airpower", "rct1ll.ride.air_powered_trains" },
    { "rct1ll.ride.aml1", "rct1ll.ride.steam_trains_american" },
    { "rct1ll.ride.aml2", "rct1ll.ride.steam_trains_american_uncovered" },
    { "rct1ll.ride.arrhyper", "rct1ll.ride.hypercoaster_trains" },
    { "rct1ll.ride.cstboat", "rct1ll.ride.coaster_boats" },
    { "rct1ll.ride.faceoff", "rct1ll.ride.face_off_cars" },
    { "rct1ll.ride.invhairp", "rct1ll.ride.inverted_hairpin_cars" },
    { "rct1ll.ride.jski", "rct1ll.ride.jet_skis" },
    { "rct1ll.ride.nemt", "rct1ll.ride.4_across_inverted_trains" },
    { "rct1ll.ride.rftboat", "rct1ll.ride.rafts" },
};
